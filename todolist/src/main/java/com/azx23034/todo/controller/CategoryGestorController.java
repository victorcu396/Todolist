...
@Tag(name = "Gestor - Categorías", description = "Gestión de categorías (disponible para gestores y administradores)")
@RestController
@RequestMapping("/gestor/categories")
@RequiredArgsConstructor
public class CategoryGestorController {
